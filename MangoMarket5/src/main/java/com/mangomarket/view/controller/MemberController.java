...
public class MemberController {
	...
	public String login(@RequestParam("id") String id, @RequestParam("pwd") String pwd, HttpServletRequest request,
	...
	public String uploadUserImg(@RequestParam("imgUrl") MultipartFile file, @RequestParam("userId") int userId,
			HttpServletRequest request, HttpSession seesion) throws IOException {
		String fullPath = "";
	...
	public String findIdOK(@RequestParam("phone") String phone, HttpServletRequest request) {
		...
		if (vo == null)
			request.setAttribute("findID", ErrorText.NOTHING.getPrint());
		else
	...
	public String findPWOK(@RequestParam("id") String id, @RequestParam("email") String email,
		...
		if (userVO == null)
			request.setAttribute("findPW", ErrorText.NOTHING.getPrint());
		else
			request.setAttribute("findPW", userVO);

		return Path.FIND_PASSWORD_PAGE.getPath();
	}

	@RequestMapping("/resetPW")
	public String resetPW(@RequestParam("pwd") String pwd, @RequestParam("id") String id,
