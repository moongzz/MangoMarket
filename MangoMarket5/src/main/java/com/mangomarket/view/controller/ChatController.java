...
public class ChatController {
	...
	public String chat(Model model, HttpServletRequest request, @RequestParam("goodsId") int goodsId,
			@RequestParam("buyerId") int buyerId, @RequestParam("sellerId") int sellerId) {
	...
	public String sendMessage(Model model, @RequestParam("content") String content, @RequestParam("fromId") int fromId,
			@RequestParam("buyer") int buyer, @RequestParam("seller") int seller,
